...
<body class=container>
	...
	<div class=container id=wrapper>
		...
		href="${pageContext.servletContext.contextPath}/read.board?seq=${ item.seq }&page=${ (param.page != null) ? param.page : 1  }&id=${ param.id }">
		${ item.title } 
				...
				<td style="width: 33%;">
					<ul class="pagination pagination-sm">		
						...
						<c:forEach var="item" items="${ navi }">
							...
							<a class="page-link" href="list.board?id=${ param.id }&page=${item.link}">${item.symbol}</a></li>
