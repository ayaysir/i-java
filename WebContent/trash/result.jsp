...
<body>
    ...
    <div class="container">
        ...
        <p>
				...
				<div>
						<p>결과</p>
				<pre><%
					System.out.println((String)request.getAttribute("1"));
					out.print((String)request.getAttribute("1"));%></pre>
				</div>
        </p>
    ...
    <footer class="footer">
        <div class="container">
            <p class="text-muted"><jsp:include page="includeFooter.jsp" flush="false"/>
