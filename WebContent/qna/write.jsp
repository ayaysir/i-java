...
<body class=container>
	...
	<form action='${pageContext.servletContext.contextPath}/writeProc.qna' method=post id=frm>
		...
		<div class=center-block>
			...
			<button type="button" class="btn btn-secondary" onclick="alert('준비중입니다.')">뒤로가기</button>
		</div>
		...
		<input type=hidden id=ctMain name=qmain>
		<input type=hidden id=ctFunc name=qfunc>
		<input type=hidden id=ctResult name=qresult>
